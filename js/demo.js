									...
									success: function (data) {  
										...
										else
										{
										   ...
										   swal({
												  ...
												  html:
													"<table cellpadding='0' cellspacing='0' border=0 style='margin-top:19px;border-color:transparent; font-size:11px; width: 100%;border-collapse: separate;border-spacing:  7px;'><tr><td align='left' valign='top' style='padding-right:2em;'>Nombre</td><td align='left' style='font-weight:bold'>"+ data.Nombre+"</td><td></td></tr><tr><td align='left' valign='top' style='padding-right:2em;'>Paterno</td><td align='left' style='font-weight:bold'>"+data.Paterno+"</td><td></td></tr><tr><td align='left' valign='top' style='padding-right:2em;'>Materno</td><td align='left' style='font-weight:bold'>"+data.Materno+"</td><td></td></tr><tr><td align='left' valign='top' style='padding-right:2em;'>Calle</td><td align='left' style='font-weight:bold'>"+data.calle+"</td><td></td></tr><tr><td align='left' valign='top' style='padding-right:2em;'>CP</td><td align='left' style='font-weight:bold'>"+data.codigoPostal+"</td><td></td></tr><tr><td align='left' valign='top' style='padding-right:2em;'>Colonia</td><td align='left' style='font-weight:bold'>"+data.colonia+"</td><td></td></tr><tr><td align='left' valign='top' style='padding-right:2em;'>Fecha nac</td><td align='left' style='font-weight:bold'>"+data.fechaDeNacimiento+"</td><td></td></tr></table>",
												  showCloseButton: true,
												  confirmButtonText:
													'<i class="glyphicon glyphicon-ok"></i>',
												  width: "315px",
