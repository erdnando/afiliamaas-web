...
;(function($){
	...
	$.movingBoxes = function(el, options){
		...
		base.setSizes = function(flag){
			...
			base.heights = base.$panels.css('height','380px').map(function(i,e){ return $(e).outerHeight(true); }).get();
		...
		base.buildNav = function() {
			...
			if (o.buildNav && base.totalPanels > 1) {
				...
				base.$panels.filter(':not(.cloned)').each(function(i){
					j = i + 1;
					a = '<a class="mb-link mb-panel' + j + '" href="#" style="display: inline-block;max-width: 100%;margin-bottom: 5px;font-weight: bold;text-align: left !important;margin-top: 6px;font-size: 13px;"></a>';
					$a = $(a);
