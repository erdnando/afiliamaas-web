...
!function ($) {
	...
	$(template).each(function (i,x) {
        ...
        template.find('.glyphicon-circle-arrow-up').mousehold($.proxy(this.increase, this));
        template.find('.glyphicon-circle-arrow-down').mousehold($.proxy(this.decrease, this));
    ...
    DRPGlobal.template =
	'<div class="spinedit">' +
	'<i id="spinumup" class="glyphicon glyphicon-circle-arrow-up"></i>' +
	'<i id="spinumdown" class="glyphicon glyphicon-circle-arrow-down"></i>' +
	'</div>';
